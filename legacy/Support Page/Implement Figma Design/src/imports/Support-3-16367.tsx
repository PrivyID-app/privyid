import svgPaths from "./svg-w724je3i78";
...
function PageHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full z-[3]" data-name="Page Header [1.0]">
...
function CardWrapper() {
  return (
    <div className="content-stretch flex gap-[16px] h-[128px] items-start relative shrink-0 w-full z-[2]" data-name="Card Wrapper">
      <SupportCard />
      <SupportCard1 />
      <SupportCard2 />
    </div>
...
function Title() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0 w-[338px]" data-name="Title">
      <TextComponent1 />
      <TextComponent2 />
    </div>
  );
...
function Search2Line() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="search-2-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="search-2-line">
          <path d={svgPaths.p34d12c00} fill="var(--fill-0, #99A0AE)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function QuickActionsSearchInput() {
  return (
    <div className="bg-white relative rounded-[16px] shrink-0 w-[400px]" data-name="Quick Actions Search Input [1.0]">
      <div className="content-stretch flex gap-[8px] items-center overflow-clip px-[20px] py-[14px] relative rounded-[inherit] w-full">
        <Search2Line />
      ...
      <div aria-hidden="true" className="absolute border-[#e1e4ea] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
}
...
function Filter3Line() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="filter-3-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="filter-3-line">
          <path d={svgPaths.p3f0b980} fill="var(--fill-0, #525866)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Text16() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['MADE_TOMMY:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#525866] text-[14px] tracking-[-0.084px] whitespace-nowrap" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        <p className="leading-[20px]">Filter Records</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[20px]" data-name="arrow-down-s-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow-down-s-line">
          <path d={svgPaths.p2c6f4a00} fill="var(--fill-0, #525866)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Buttons4() {
  return (
    <div className="bg-white h-[40px] relative rounded-[10px] shrink-0" data-name="Buttons [1.0]">
      <div className="content-stretch flex gap-[4px] h-full items-center justify-center overflow-clip p-[10px] relative rounded-[inherit]">
        <Filter3Line />
        <Text16 />
        <ArrowDownSLine />
      </div>
  ...
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] relative shrink-0" data-name="Text">
      <div className="flex flex-col font-['MADE_TOMMY:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.084px] whitespace-nowrap" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        <p className="leading-[20px]">New Ticket</p>
      </div>
    </div>
  );
}
...
function Buttons5() {
  return (
    <div className="bg-[#171b34] content-stretch flex gap-[4px] h-[40px] items-center justify-center overflow-clip p-[10px] relative rounded-[10px] shrink-0" data-name="Buttons [1.0]">
      <AddLine />
      <Text17 />
    </div>
  );
...
function Container1() {
  return (
    <div className="content-stretch flex items-end justify-between py-[10px] relative shrink-0 w-full" data-name="Container">
      <Title />
      <QuickActionsSearchInput />
      <Buttons />
    </div>
  );
}
      ...
      <div className="absolute bottom-[-14px] h-0 left-0 right-0" data-name="Line">
        <div className="absolute inset-[-2px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 2">
            <line id="Line" stroke="var(--stroke-0, #171B34)" strokeWidth="2" x2="44" y1="1" y2="1" />
          </svg>
        </div>
      </div>
    </div>
...
function Checkbox() {
  return (
    <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Checkbox [1.0]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e1e4ea] left-1/2 rounded-[4px] size-[16px] top-1/2" data-name="bg" />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white left-1/2 rounded-[2.6px] shadow-[0px_2px_2px_0px_rgba(27,28,29,0.12)] size-[13px] top-1/2" data-name="box" />
    </div>
  );
}
...
function Cell() {
  return (
    <div className="content-stretch flex items-center p-[10px] relative shrink-0" data-name="Cell">
      <Checkbox />
    </div>
  );
}
...
function Cell1() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center p-[10px] relative shrink-0 w-[100px]" data-name="Cell">
      <TextComponent6 />
    </div>
  );
}
...
function Cell2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Cell">
...
function Cell3() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center p-[10px] relative shrink-0 w-[150px]" data-name="Cell">
      <TextComponent8 />
    </div>
  );
}
...
function Cell4() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center p-[10px] relative shrink-0 w-[200px]" data-name="Cell">
      <TextComponent9 />
    </div>
  );
}
...
function Cell7() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative shrink-0 w-[100px]" data-name="Cell">
      <TextComponent12 />
    </div>
  );
}
...
function TableHeader() {
  return (
    <div className="bg-[#f8f8f8] content-stretch flex items-center relative shrink-0 w-full" data-name="Table header">
      <div aria-hidden="true" className="absolute border-[#e1e4ea] border-b-[0.5px] border-solid inset-0 pointer-events-none" />
      <Cell />
      <Cell1 />
      <Cell2 />
      <Cell3 />
...
function Cell8() {
  return (
    <div className="content-stretch flex h-full items-center p-[10px] relative shrink-0" data-name="Cell">
      <Checkbox1 />
    </div>
  );
}
...
function Cell9() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center p-[10px] relative shrink-0 w-[100px]" data-name="Cell">
      <TextComponent13 />
    </div>
  );
}
...
function TextComponent14() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Text Component">
      <p className="font-['MADE_TOMMY:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0e121b] text-[12px]" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
...
function Cell11() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center p-[10px] relative shrink-0 w-[150px]" data-name="Cell">
      <TextComponent15 />
    </div>
  );
}

function SelectBoxCircleFill() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="select-box-circle-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="select-box-circle-fill">
          <path d={svgPaths.p10d2d640} fill="var(--fill-0, #624C18)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Badge() {
  return (
    <div className="bg-[#ffecc0] content-stretch flex gap-[2px] items-center justify-center overflow-clip pl-[4px] pr-[8px] py-[2px] relative rounded-[999px] shrink-0" data-name="Badge [1.0]">
      <SelectBoxCircleFill />
      <p className="font-['MADE_TOMMY:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#624c18] text-[12px]" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        IN PROGRESS
      </p>
    </div>
  );
...
function TableRowCell() {
  return (
    <div className="content-stretch flex gap-[8px] h-full items-center overflow-clip p-[12px] relative shrink-0 w-[200px]" data-name="Table Row Cell [1.0]">
      <Badge />
    </div>
  );
}
...
function EditBoxLine() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="edit-box-line">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="edit-box-line">
          <path d={svgPaths.p24901500} fill="var(--fill-0, #525866)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Buttons6() {
  return (
    <div className="content-stretch flex items-center justify-center overflow-clip p-[6px] relative rounded-[8px] shrink-0" data-name="Buttons [1.0]">
      <EditBoxLine />
    </div>
  );
}
...
function TableRowCell1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[44px] items-center justify-center overflow-clip p-[12px] relative shrink-0 w-[100px]" data-name="Table Row Cell [1.0]">
      <Buttons6 />
    </div>
  );
}
...
function TicketTableRow() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Ticket Table Row">
...
function TextComponent19() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Text Component">
      <p className="font-['MADE_TOMMY:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0e121b] text-[12px]" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        Batch Verification Pricing Question
      </p>
    </div>
  );
}
...
function SelectBoxCircleFill1() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="select-box-circle-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="select-box-circle-fill">
          <path d={svgPaths.p10d2d640} fill="var(--fill-0, #0B4627)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Badge1() {
  return (
    <div className="bg-[#c2f5da] content-stretch flex gap-[2px] items-center justify-center overflow-clip pl-[4px] pr-[8px] py-[2px] relative rounded-[999px] shrink-0" data-name="Badge [1.0]">
      <SelectBoxCircleFill1 />
      <p className="font-['MADE_TOMMY:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0b4627] text-[12px]" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        RESOLVED
      </p>
    </div>
  );
...
function TicketTableRow1() {
  return (
    <div className="bg-[#fafafa] content-stretch flex items-center relative shrink-0 w-full" data-name="Ticket Table Row">
      <div className="flex flex-row items-center self-stretch">
        <Cell14 />
      </div>
      <div className="flex flex-row items-center self-stretch">
...
function SelectBoxCircleFill4() {
  return (
    <div className="relative shrink-0 size-[12px]" data-name="select-box-circle-fill">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
        <g id="select-box-circle-fill">
          <path d={svgPaths.p10d2d640} fill="var(--fill-0, #124B68)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Badge4() {
  return (
    <div className="bg-[#c0eaff] content-stretch flex gap-[2px] items-center justify-center overflow-clip pl-[4px] pr-[8px] py-[2px] relative rounded-[999px] shrink-0" data-name="Badge [1.0]">
      <SelectBoxCircleFill4 />
      <p className="font-['MADE_TOMMY:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#124b68] text-[12px]" style={{ fontFeatureSettings: "\'calt\' 0, \'liga\' 0" }}>
        PENDING
      </p>
    </div>
  );
...
function RowWrapper() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Row Wrapper">
      <TicketTableRow />
      <TicketTableRow1 />
      <TicketTableRow2 />
      <TicketTableRow3 />
...
function Table() {
  return (
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Table">
...
function ContentWrapper() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-center min-h-px min-w-px overflow-x-clip overflow-y-auto relative rounded-[16px] w-full z-[1]" data-name="Content Wrapper">
      <Container1 />
      <TabMenuHorizontal />
      <Table />
    </div>
