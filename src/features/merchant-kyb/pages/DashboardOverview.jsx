...
const DashboardOverview = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      console.log(
        `[KYB Dashboard] Fetched ${vAll?.length || 0} total records for merchant:`,
        mId,
      );
      ...
      console.error("KYB Dashboard Fetch Error:", error);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="content_area">
        ...
        <div className="quick_actions">
          ...
          <div className="filter_wrapper">
            ...
            <button
              className="secondary_button"
              onClick={() => navigate(`/m/${merchantId}/kyb/api`)}
            >
            ...
            <button
              ...
              onClick={() =>
                navigate(`/m/${merchantId}/kyb/batch-verification`)
              }
            >
        ...
        <div className="recent_verifications">
          <div className="top_area">
            ...
            <a href={`/m/${merchantId}/kyb/history`} className="view_all_link">
              <p>View All</p>
