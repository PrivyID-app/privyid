...
const TokensPage = () => {
  ...
  const fetchTokens = async () => {
    ...
    try {
      ...
      // 1. Fetch Verifications (Combined)
      ...
      const mappedReports = data.map((v) => ({
        ...
        type: v.verification_type?.toUpperCase() || "COMBINED",
        name: v.metadata?.full_name || v.customer_name || "Unknown Identity",
  ...
  return (
    <div className="content_wrapper">
      <PageHeader
        ...
        description="View your combined verified results and session tokens"
        notificationIconRoute={
          urlMerchantId
            ? `/m/${urlMerchantId}/combined/notifications`
            : merchantId
              ? `/m/${merchantId}/combined/notifications`
              : null
        }
      />
      ...
      <div className="content_area">
        <div className="recent_verifications">
          <div className="top_area">
            <p className="section_title">Verified Reports (KYC & KYB)</p>
