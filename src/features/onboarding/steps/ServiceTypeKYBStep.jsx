...
const ServiceTypeKYBStep = ({ onNext, onBack, onStepChange }) => {
  ...
  const [selectedIds, setSelectedIds] = useState(Array.isArray(kybOptions) ? kybOptions : []);
  ...
  return (
    <div className="plan_type">
      ...
      <div className="step_title">
        <p className="step_title_text_bg">Select Service Type - KYB Only</p>
      ...
      <div className="service_step_body_kyc">
        <div className="service_selector">
            <div className="service_selector_dropdown">
                ...
                <div style={{ position: 'relative' }}>
                    <select id="service_selector" defaultValue="kyb" onChange={handleSwitchService}>
        ...
        <div className="selector_counter">
            <p className="selector_counter_text">{selectedIds.length} of {kybServices.length} selected</p>
        </div>
      </div>
