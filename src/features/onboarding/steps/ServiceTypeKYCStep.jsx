...
const ServiceTypeKYCStep = ({ onNext, onBack, onStepChange }) => {
  ...
  const [selectedIds, setSelectedIds] = useState(Array.isArray(kycOptions) ? kycOptions : []);
  ...
  return (
    <div className="plan_type">
      ...
      <div className="step_title">
        <p className="step_title_text_bg">Select Service Type - KYC Only</p>
      ...
      <div className="service_step_body_kyc">
        <div className="service_selector">
            <div className="service_selector_dropdown">
                ...
                <div style={{ position: 'relative' }}>
                    <select id="service_selector" defaultValue="kyc" onChange={handleSwitchService}>
        ...
        <div className="selector_counter">
            <p className="selector_counter_text">{selectedIds.length} of {kycServices.length} selected</p>
        </div>
      </div>
