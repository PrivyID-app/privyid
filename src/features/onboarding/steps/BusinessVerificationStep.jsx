    ...
    <div className="info_modal dark">
      ...
      <div className="modal_content">
        <div className="modal_title">
          <p className="modal_content_title">Expected Processing Time - 24 hours</p>
          <span className="material-symbols-outlined hide_icon close_icon" onClick={() => setIsVisible(false)}>close</span>
        </div>
        <p className="modal_content_text">You'll receive an email once your business is verified. You can still explore the dashboard in the meantime.</p>
      </div>
    </div>
  );
};
    ...
    <div className="info_modal white">
      ...
      <div className="modal_content">
        <div className="modal_title">
          ...
          <span className="material-symbols-outlined close_icon" onClick={() => setIsVisible(false)}>close</span>
        </div>
        <p className="modal_content_text">KYB verification helps us ensure platform security, prevent fraud, and meet regulatory requirements. Most verifications are approved within 24 hours.</p>
      </div>
    </div>
  );
};
...
const BusinessVerificationStep = ({ onNext, onBack }) => {
  ...
  const isFormValid = formData.business_name && 
    ...
    <div className="business_verification">
      <div className="plan_type">
        ...
        <div className="step_title">
          <p className="step_title_text_bg">Business Verification (KYB)</p>
          <p className="step_title_text_sm">To maintain platform integrity and comply with regulations, we need to verify your business.</p>
        </div>

        <div className="business_verification_body">
          <form id="business_verification_form" className="business_verification_form" noValidate>
            ...
            <div className="supporting_documents">
              <label htmlFor="supporting_documents">Supporting Documents <span className="required">*</span></label>
              <label 
              ...
              >
                <div className="dropzone_content">
                  <div className="dropzone_icon">
                    <span className="material-symbols-outlined" style={{ fontSize: '2.5rem' }}>cloud_upload</span>
                  </div>
